        ...
        <div className="bg-white py-8 px-4 shadow-lg sm:rounded-2xl sm:px-10 border border-gray-100">
          <div className="mb-6 text-center border-b border-gray-100 pb-4">
            <p className="text-sm text-gray-600 leading-relaxed font-medium">
              Sistem Autentikasi Lokal (Hosting Mandiri)
            </p>
            <p className="text-[11px] text-gray-400 mt-1">
              Tidak membutuhkan Firebase atau Akun Google. Masukkan kredensial administrator Anda di bawah ini.
            </p>
          </div>
          ...
          <div className="mt-6 border-t border-gray-100 pt-4 text-center">
            <span className="text-[10px] text-gray-400 font-semibold tracking-wider uppercase">
              100% Self-Hosted &bull; Tanpa Google &bull; Tanpa Firebase
            </span>
          </div>
        </div>
      </div>
