...
import { ArrowLeft, FileText, Download, ExternalLink, Share2, ArrowRight, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <div className="bg-white px-4 sm:px-6 py-3 border-b border-gray-100 flex items-center justify-between sticky top-0 z-50 shadow-sm">
        ...
        <button onClick={handleShare} className="p-2 -mr-2 text-gray-700 hover:bg-gray-100 hover:text-green-700 rounded-full transition-colors flex-shrink-0" title="Bagikan Pengumuman">
          <Share2 size={18} />
        </button>
      </div>
